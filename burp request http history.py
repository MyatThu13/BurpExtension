        ...
        if messageIsRequest:
            try:
                ...
                if service:
                    ...
                    self._stdout.println(f"Request intercepted for {protocol}://{host}:{port}")
                else:
                    self._stdout.println("Request intercepted, but service details are not available.")
                ...
                # Manually add the modified request to the HTTP history
